...
public class DataBase
{
    ...
    public bool addPayment(String payId, String stdId, String date, String amount)
    {
        bool success = false;
        connect();
        ...
        try
        {
            ...
            command.CommandText = "select balance_payment from student where student_number=@sid";
            command.Prepare();
            reader = command.ExecuteReader();
            ...
            command.CommandText = "update student set balance_payment = @balance where student_number = @sid";
            command.Prepare();
